 ...
 * @since 1.0.0
 */
if ( class_exists( 'WP_Widget' ) && ! class_exists( 'EcrannoirTwentyOne_Widget_LinkPage' ) ) {

    class EcrannoirTwentyOne_Widget_LinkPage extends \WP_Widget {
        ...
        public function widget( $args, $instance ) {
            ...
            ecrannoir_twenty_one_block_button( $page_link, $cta_label);
            ?>
            <?php
