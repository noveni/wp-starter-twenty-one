 ...
 *
 */
class EcranNoirTwentyOne_Options 
{
    /**
    ...
    public function addPage()
    {
        add_options_page(
            ...
            'ecrannoirtwentyone-theme-settings', // page URL slug
    ...
    {
        $this->options = get_option( 'ecrannoirtwentyone-settings-option' );
        ?>
        <div class="wrap">
            <h1>Thème settings</h1>
            <form method="post" action="options.php">
                <?php settings_fields( 'ecrannoirtwentyone-settings' ); ?>
                <?php do_settings_sections( 'ecrannoirtwentyone-theme-settings' ); ?>
                <?php submit_button(); ?>
            </form>
        </div>
    ...
    public function pageInit()
    {
        ...
        register_setting(
            'ecrannoirtwentyone-settings', // settings group name
            'ecrannoirtwentyone-settings-option', // option name
    ...
    public function maintenanceModeCallback()
    {
        ...
        ?>
        <div>
        <input type="radio" id="maintenance_mode_off" name="ecrannoirtwentyone-settings-option[maintenance_mode]" value="off" <?php echo $field_value === false ? 'checked' : '' ?>>
        <label for="maintenance_mode_off">Off</label>
        </div>
        <div>
            <input type="radio" id="maintenance_mode_on" name="ecrannoirtwentyone-settings-option[maintenance_mode]" value="on" <?php echo $field_value === true ? 'checked' : '' ?>>
    ...
    public function headerLayoutHtml()
    {
        ...
        ?>
        <select name="ecrannoirtwentyone-settings-option[header_layout]" id="header-layout-select">
    ...
    public function googleAnalyticsFieldHtml()
    {
        ...
        printf(
            '<input type="text" id="ga_measurement_id" name="ecrannoirtwentyone-settings-option[ga_measurement_id]" value="%s" />',
